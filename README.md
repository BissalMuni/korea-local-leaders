...
```bash
python crawler/crawl.py            # 광역 17곳 -> data/governors.json (슬로건·CI·공약 포함)
...
광역 17곳·기초 227곳 개수, 필수 필드 존재, code 유일성, 기초→광역 참조 무결성을
...
> 목록 데이터만** 제공하고, **지도는 경계가 확실한 광역 17곳**으로 운영합니다.
...
**광역 17곳**(시·도지사)과 **기초 227곳**(시장·군수·구청장)을 수집합니다. 각 기관에서
